...
class SaveImage:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "output_path": ("STRING", {"default": "", "tooltip": "The directory to save the image. If empty, uses the default output directory."})
            },
            "hidden": {
    ...
    CATEGORY = "image"
    DESCRIPTION = "Saves the input images to the specified directory or ComfyUI output directory."
